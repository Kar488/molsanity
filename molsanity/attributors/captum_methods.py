...
them to graphs; we repackage into MolSanity's common :class:`Attribution` schema.
...
class CaptumAttributor:
    ...
    def _build_explainer(self):
        ...
        kwargs = {}
        if self.method in _STEP_METHODS:
            kwargs["n_steps"] = self.ig_steps
        return Explainer(
    ...
    def attribute(self, data, target: int | None = None) -> Attribution:
        ...
        return Attribution(
            ...
            method=self.method, target=tgt, meta={"pred": pred},
        )
