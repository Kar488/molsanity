...
_Last run: `matrix.yaml` @ 20260728_162231._

## Cell tally

- done: **12**  · failed: **0**  · skipped/blocked: **0**
...
| ESOL | GINE | IntegratedGradients | done | acc=0.00 gt_auroc=nan n=20 (capped) |
| ESOL | GINE | GNNExplainer | done | acc=0.00 gt_auroc=nan n=20 (capped) |
| FreeSolv | GINE | IntegratedGradients | done | acc=0.00 gt_auroc=nan n=20 (capped) |
